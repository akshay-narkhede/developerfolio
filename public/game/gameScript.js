...
// var rounds = [5, 5, 3, 2, 2];
var rounds = [5, 4, 3, 2];
// var rounds = [1];
var colors = ['#1abc9c', '#ff5e5e', '#3498db', '#8c52ff', '#ce64fa'];
...
var Game = {
    ...
    update: function () {
        ...
        if (this.player.score === rounds[this.round]) {
            ...
            if (!rounds[this.round + 1]) {
                ...
                setTimeout(function () { console.log("Player won") }, 5000);
    ...
    draw: function () {
        ...
        this.context.font = '100px Tektur';
